...
安卓手机用户请使用Termux运行这段命令：`apt-get update -y && apt-get upgrade -y && curl -sSL https://raw.githubusercontent.com/ToolDelta/ToolDelta/58-install-shell/install.sh | bash`
