...
之后出现的选择验证服务器并登录，如果你使用的验证服务器是 FastBuilder官方验证服务器 的话， 你可以在 <a href="https://user.fastbuilder.pro"><b><font color="0088FF">FastBuilder的用户中心->用户档案</font></b>[点我前往用户中心]</a> 找到 下载FBToken， 并用记事本或者mt管理器打开， 复制其中的内容， 然后粘贴到ToolDelta上
